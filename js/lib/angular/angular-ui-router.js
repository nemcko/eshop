      ...
      if (!isDefined(toState)) {
        ...
        if (evt.retry) {
          ...
          retryTransition.then(function() {
            ...
            redirect.defaultOptions.$retry = true;
            return $state.transitionTo(redirect.to, redirect.toParams, redirect.defaultOptions);
          }, function() {
            return TransitionAborted;
          });
          syncUrl();
        ...
        options = redirect.defaultOptions;
    ...
    link: function(scope, element, attrs, uiSrefActive) {
      ...
      element.bind("click", function(e) {
        ...
        if ((button === 0 || button == 1) && !e.ctrlKey && !e.metaKey && !e.shiftKey) {
          // HACK: This is to allow data-ng-clicks to be processed before the transition is initiated:
          $timeout(function() {
