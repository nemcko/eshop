 ...
 * @example
    <doc:example>
      <doc:source>
        <div data-ng-show="!showActions" data-ng-swipe-left="showActions = true">
          Some list content, like an email in the inbox
        </div>
        <div data-ng-show="showActions" data-ng-swipe-right="showActions = false">
          <button data-ng-click="reply()">Reply</button>
